...
<head> 
  ...
  <body>
    ...
    <header>
      ...
      <br>
      <br>
      <center><h1 class="italico">CADASTRO CLIENTE</h2></center>
      <br>
      <br>
      <div class ="form-agenda">

      <form action="clientePDO.php" method="POST">
      <center>
      <h5><br><br>
        <div class="mb-3 w-50" >
          <label for="exampleFormControlInput1" class="form-label">Digite o nome do cliente:</label>
          <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Nome Cliente" name="nome" required>
        </div>
        <div class="mb-3 w-50">
          <label for="exampleFormControlInput1" class="form-label">Digite o CPF:</label>
        ...
        <div class="mb-3 w-50">
          <label for="exampleFormControlInput1" class="form-label">Informe um telefone:</label>
          <input type="text" class="form-control" id="exampleFormControlInput1"  name="telefone" placeholder="(11) 98355-0644" required>
        </div>
        </h5>
        </center>
      <br><br>
