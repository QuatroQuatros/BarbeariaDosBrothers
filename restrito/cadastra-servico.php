...
<head> 
  ...
  <body>
    ...
    <header>
      ...
      <br>
      <br>
      <center><h1 class="italico">CADASTRO SERVIÇO</h1></center>
      <br>
      <br>
      <div class ="form-agenda">

      <center><form action="servicoPDO.php" 
        method="POST"
        ...
        <br><br>
        <div class="mb-3 w-50" >
          <label for="exampleFormControlInput1" class="form-label">Digite o nome do serviço:</label>
          <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Nome Serviço" name="textoServico" required>
        </div>
        <div class="mb-3 w-50">
          <label for="exampleFormControlInput1" class="form-label">Digite a descrição do serviço:</label>
          <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Descrição Serviço" name="descServico" required>
        </div>
        <div class="mb- w-50">
          <label for="exampleFormControlInput1" class="form-label">Insira a foto do serviço:</label>
          <input type="file" class="form-control" id="exampleFormControlInput1" name="fotoServico" required>
        </div>
