...
<center><h1 class="display-1">Serviços</h1></center><br><br>
    ...
    <?php  
      ...
      foreach ($servicos as $s) {
              ...
              echo("<img class='bd-placeholder-img rounded-circle' width='180' height='180' 
                src= restrito/".$s["fotoServico"]." height=400px width=500px><rect width='100%' height='100%'' fill='#777'/>");
                echo("<h2>". $s["textoServico"]."</h2>");
                echo("<p>". $s["descServico"]."</p>");
                echo("<p><a class='btn btn-secondary' href='PHP/form-login.php'>Corte já Brother&raquo;</a></p>");
                echo("</div><!-- /.col-lg-4 -->");
              }
